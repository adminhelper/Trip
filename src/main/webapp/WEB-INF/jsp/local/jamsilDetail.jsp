...
<section class="page-section bg-s" id="portfolio">
    <div class="container">
        <div class="text-center">
            <h1 class="section-heading">${jamsil.title}</h1>
        </div>
        <div class="container">
            <hr size="10px">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="modal-body">
                        <img src="${jamsil.firstimage}">
                        <br>
                        <br>
                        <c:if test="${jamsil.overview != null}">
                            <dl>
                                <dt>설명</dt>
                                <dd>${jamsil.overview}</dd>
                            </dl>
                        </c:if>
                        <dl>
                            <dt>주소</dt>
...
<script>
    ...
    var mapX = ${jamsil.mapx};
    var mapY = ${jamsil.mapy};
