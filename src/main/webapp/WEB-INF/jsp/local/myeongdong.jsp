...
<section class="page-section bg-s" id="portfolio">
    <div class="container">
        <div class="text-center">
            ...
            <h3 class="section-subheading text-muted">관광객의 필수코스 1순위</h3>
        </div>
                ...
                <div class="col-lg-3 col-sm-6 item ${data.contenttypeid}">
                    <div class="portfolio-item">
                        <a class="portfolio-link"
                           href="/local/myeongdong/detail?contentid=${data.contentid}&typeid=${data.contenttypeid}">
            ...
            <c:if test="${paging.prev}">
                <li class="page-item">
                    ...
                    <a class="page-link" style="color: black"
                       href="<c:url value='myeongdong?pageNum=${paging.startPage-1}&contenttypeid=${type}}'/>" aria-label="Previous">
                        이전
                    </a>
...
<c:url var="getBoardListURL" value="/local/myeongdong"></c:url>
<script>
    function onBtn(e) {
        if(e == undefined){
