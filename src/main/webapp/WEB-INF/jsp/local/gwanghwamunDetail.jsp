...
<section class="page-section bg-s" id="portfolio">
    <div class="container">
        <div class="text-center">
            <h1 class="section-heading">${gwanghwamun.title}</h1>
        </div>
        <div class="container">
            <hr size="10px">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="modal-body">
                        <img src="${gwanghwamun.firstimage}">
                        <br>
                        <br>
                        <c:if test="${gwanghwamun.overview != null}">
                            <dl>
                                <dt>설명</dt>
                                <dd>${gwanghwamun.overview}</dd>
                            </dl>
                        </c:if>
                        <dl>
                            <dt>주소</dt>
                            <dd>${gwanghwamun.addr1}</dd>
                            <dt>
...
<script>
    ...
    var mapX = ${gwanghwamun.mapx};
    var mapY = ${gwanghwamun.mapy};
