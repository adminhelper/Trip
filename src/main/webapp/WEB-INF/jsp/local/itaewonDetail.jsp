...
<section class="page-section bg-s" id="portfolio">
    <div class="container">
        <div class="text-center">
            <h1 class="section-heading">${itaewon.title}</h1>
        </div>
        <div class="container">
            <hr size="10px">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="modal-body">
                        <img src="${itaewon.firstimage}">
                        <br>
                        <br>
                        <c:if test="${itaewon.overview != null}">
                            <dl>
                                <dt>설명</dt>
                                <dd>${itaewon.overview}</dd>
                            </dl>
                        </c:if>
                        <dl>
                            <dt>주소</dt>
...
<script>
    ...
    var mapX = ${itaewon.mapx};
    var mapY = ${itaewon.mapy};
